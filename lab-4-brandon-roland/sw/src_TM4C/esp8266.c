...
//
    ...
    char    eid[32]           = "bmg3364_rxw62";         // Your EID goes here
    char    ssid[32]          = "RolandPhone";         // SSID for the WAP you are using
    char    pass[32]          = "chudmoment";         // Password for the access to the WAP
    char    mqtt_broker[32]   = "broker.emqx.io";         // IP Address to your Broker
